    ...
    <div className="flex flex-col justify-center items-center h-screen w-screen bg-gray-900">
      <main className="container flex flex-col overflow-y-scroll p-2">
        <div className="flex flex-col justify-center items-center h-40 sm:h-60">
          ...
          <h1 className="text-gray-100 text-2xl sm:text-4xl my-3">
            Cantina SENAI
          </h1>
          <span className="text-gray-100 text-sm sm:text-lg my-3">
            Faça login abaixo
          </span>
        </div>
        <form className="flex flex-col justify-center items-center gap-3 p-3 w-full">
          ...
          {carregando ? (
            <button
              disabled
              className=" text-gray-900 w-full sm:w-96 bg-gray-100 h-10 rounded flex justify-center items-center duration-500"
            >
            ...
            <button
              ...
              onClick={(e) => {
                setCarregando(true);
                manipulaLogin(e, email, senha).finally(() =>
                  setCarregando(false)
                );
              }}
